...
**Note**: Do not put real credit card information into any of the things, they are decorative and these are not designed to handle sensitive information. Any information sent without a signed SSL certificate can and *will* be stolen by hackers if you deploy this out to the web.
